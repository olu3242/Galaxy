...
const NAV_ITEMS = [
  ...
  { href: '/dashboard/templates', label: 'WA Templates', icon: '📋' },
  { href: '/dashboard/agents', label: 'Agent OS', icon: '🤖' },
  { href: '/dashboard/delegation', label: 'Delegation', icon: '🔑' },
  { href: '/dashboard/analytics', label: 'Custom Analytics', icon: '📉' },
