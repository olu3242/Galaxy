...
export default function GalaxyPage() {
  ...
  return (
    <div className={`${syne.variable} ${dmSans.variable}`} style={{ fontFamily: 'var(--font-body)' }}>
      {/* NAV */}
      <nav id="nav" className={scrolled ? 'scrolled' : ''} style={{ fontFamily: 'var(--font-body)' }}>
        ...
        <div className="hero-right">
          <div className="mission-control">
            ...
            <div className="mc-ring">
              <div className="mc-ring-inner" style={{ fontFamily: 'var(--font-head)' }}>G</div>
            </div>
            ...
            <div className="mc-card card-tasks">
              ...
              <div className="mc-card-row">
                <div className="mc-card-value" style={{ fontFamily: 'var(--font-head)' }}>247</div>
            ...
            <div className="mc-card card-approval">
              ...
              <div className="mc-card-value" style={{ fontFamily: 'var(--font-head)' }}>3</div>
            ...
            <div className="mc-card card-report">
              ...
              <div className="mc-card-row">
                <div className="mc-card-value" style={{ fontFamily: 'var(--font-head)', fontSize: '18px' }}>Ready</div>
      ...
      <section className="problem-section" id="solutions">
        <div className="section-header reveal">
          ...
          <p className="section-sub">
            Most organizations are managing complex operations with tools built for casual conversations.
          </p>
        </div>
        <div className="problem-grid">
          {[
            { icon: '🔕', color: 'pi-red', title: 'Decisions disappear in group chats', desc: 'Important agreements, approvals, and directives get buried under hundreds of unrelated messages. By tomorrow, no one remembers who decided what.' },
            { icon: '⏰', color: 'pi-amber', title: 'Follow-ups fall through the cracks', desc: "Tasks get assigned in conversation and then forgotten. No system tracks who committed to what, or whether it was ever done." },
            { icon: '📊', color: 'pi-violet', title: 'Reporting takes too much time', desc: 'Creating reports means chasing multiple people for updates, compiling scattered information, and hoping nothing was missed.' },
            { icon: '👁️', color: 'pi-red', title: 'Leaders lack visibility', desc: "Senior leaders have no real-time view of what's happening across teams. Oversight requires manual check-ins and status meetings." },
      ...
      <section className="how-section">
        <div className="how-inner">
          ...
          <div className="how-steps reveal">
            {[
              { num: '1', label: 'Step One', title: 'Keep Using The Tools Your Team Already Knows', desc: "No new apps. No retraining. No change in behavior. Galaxy works inside the communication channels your team is already using every day. The only thing that changes is what's possible." },
              { num: '2', label: 'Step Two', title: 'Bring Structure To Everyday Operations', desc: 'Every message becomes a tracked action. Every approval is logged. Every task has an owner, a deadline, and a status. Accountability builds itself into the fabric of your organization.' },
              { num: '3', label: 'Step Three', title: 'Get Visibility Across Your Organization', desc: "Leaders see everything in real time. Automated reports. Instant dashboards. Complete records. You always know what's happening, what's overdue, and what needs your attention." },
            ].map((step) => (
              <div className="how-step" key={step.num}>
                ...
                <div className="step-title" style={{ fontFamily: 'var(--font-head)' }}>{step.title}</div>
      ...
      <section className="bento-section" id="solutions">
        ...
        <div className="bento-grid reveal">
          <div className="bento-card span3 large">
            ...
            <div className="bento-title" style={{ fontFamily: 'var(--font-head)' }}>Coordinate Every Ministry With Confidence</div>
          ...
          <div className="bento-card span3 large">
            ...
            <div className="bento-title" style={{ fontFamily: 'var(--font-head)' }}>Keep Field Teams Connected And Accountable</div>
          ...
          <div className="bento-card span2">
            ...
            <div className="bento-title" style={{ fontFamily: 'var(--font-head)' }}>Bring Staff, Parents &amp; Administration Together</div>
          ...
          <div className="bento-card span2">
            ...
            <div className="bento-title" style={{ fontFamily: 'var(--font-head)' }}>Manage Members Without The Administrative Burden</div>
          ...
          <div className="bento-card span2">
            ...
            <div className="bento-title" style={{ fontFamily: 'var(--font-head)' }}>Turn Engagement Into Organized Action</div>
          ...
          <div className="bento-card span3">
            ...
            <div className="bento-title" style={{ fontFamily: 'var(--font-head)' }}>Track Participation, Approvals, And Activities</div>
      ...
      <section className="outcomes-section">
        <div className="outcomes-inner">
          <div className="section-header centered reveal">
            ...
            <h2 className="section-h2" style={{ fontFamily: 'var(--font-head)' }}>What Changes With Galaxy?</h2>
            <p className="section-sub" style={{ textAlign: 'center', margin: '0 auto' }}>
              The transformation happens immediately. Here&apos;s what organizations experience within
              the first 30 days.
            </p>
          </div>
          <div className="outcomes-grid reveal">
            {[
              { icon: '📉', title: 'Reduce Manual Follow-Up', desc: 'Galaxy automatically tracks commitments, sends reminders, and escalates overdue items. You stop chasing.' },
              { icon: '🎯', title: 'Improve Accountability', desc: 'Every action is logged with a timestamp, owner, and outcome. Nothing disappears. Everyone is responsible.' },
              { icon: '👁️', title: 'Increase Visibility', desc: 'Leaders get real-time dashboards showing the health of their entire operation at a glance.' },
              { icon: '⚡', title: 'Coordinate Faster', desc: 'Structured workflows replace ad-hoc coordination. Teams move faster because everyone knows their role.' },
              { icon: '🗄️', title: 'Keep Records Organized', desc: 'Every decision, approval, and activity is automatically documented and instantly searchable.' },
            ].map((item) => (
              <div className="outcome-item" key={item.title}>
                <div className="outcome-icon">{item.icon}</div>
                <div className="outcome-title" style={{ fontFamily: 'var(--font-head)' }}>{item.title}</div>
        ...
        <div className="testimonials-grid">
          <div className="testi-card featured reveal">
            ...
            <p className="testi-text">
              We were managing 800 members across 12 different groups. Galaxy gave us one place where
              everything actually happens — and a level of accountability we never had before.
            </p>
            <div className="testi-author">
              <div className="testi-avatar" style={{ fontFamily: 'var(--font-head)' }}>EA</div>
              <div>
          ...
          <div className="testi-card reveal reveal-delay-1">
            ...
            <p className="testi-text">
              ...
              what&apos;s happening on the ground without being there. The visibility is unprecedented.
            </p>
            <div className="testi-author">
              <div className="testi-avatar" style={{ background: 'linear-gradient(135deg,var(--gblue),var(--gteal))', fontFamily: 'var(--font-head)' }}>MO</div>
              <div>
          ...
          <div className="testi-card reveal reveal-delay-2">
            <span className="testi-quote-mark">&ldquo;</span>
            <p className="testi-text">
              Reporting that used to take two days now takes twenty minutes. Our donors get accurate,
              timely updates and our board has complete confidence in our operations.
            </p>
            <div className="testi-author">
              <div className="testi-avatar" style={{ background: 'linear-gradient(135deg,var(--gteal),var(--gblue))', fontFamily: 'var(--font-head)' }}>TC</div>
              <div>
        ...
        <div className="faq-inner">
          <div className="reveal">
            ...
            <p className="faq-sidebar-sub">
              Still have something we haven&apos;t covered? We&apos;d love to hear from you directly.
            </p>
        ...
        <div className="cta-inner reveal">
          ...
          <div className="cta-form-group" style={{ marginTop: '40px' }}>
            ...
            <button
              ...
              style={{ padding: '14px 28px', borderRadius: '100px', fontSize: '14px', fontFamily: 'var(--font-body)' }}
      ...
      <footer>
        <div className="footer-main">
          <div className="footer-brand">
            ...
            <p className="footer-brand-desc" style={{ marginTop: '16px' }}>
              The Operating System For Organizations. Built for churches, NGOs, schools, cooperatives,
              and communities.
            </p>
        ...
        <div className="footer-bottom">
          <div className="footer-bottom-left">
            ...
            <a href="mailto:hello@galaxyos.co" style={{ color: 'var(--gm)', textDecoration: 'none' }}>
              hello@galaxyos.co
            </a>
          </div>
